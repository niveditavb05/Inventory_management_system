...
//    addPurchaseDAO
     public void addPurchaseDAO(ProductDTO productdto){
        try {
            ...
            String pc=productdto.getProductCode();
            if(checkStock(pc)==true){
                try {
        ...
        try{
            ...
            if(productDTO.getQuantity()>quantity){
                ...
                try{
                    ...
                    String qry="INSERT INTO salesreport(date,productcode,customercode,quantity,revenue,soldby) VALUES('"+sellDate+"','"+pc+"','"+customersCode+"','"+qty+"','"+totalRevenue+"','"+username+"')";
                    stmt.executeUpdate(q);
